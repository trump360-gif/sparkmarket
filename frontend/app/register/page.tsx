...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center pt-16 pb-16 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">함께 시작해요!</p>
        </div>
